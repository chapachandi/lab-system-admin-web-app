...
// Add this stableSort function to the same file as EnhancedTable
function stableSort(array, comparator) {
  ...
  // Add this getComparator function to the same file as EnhancedTable
...
function EnhancedTable(props) {
  ...
  const [dense, setDense] = React.useState(densePadding || false);
